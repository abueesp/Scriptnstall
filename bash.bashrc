...
alias debug="sudo apt-get install apport-retrace apython-problem-report python-apport -y; apropos apport; read -p 'Write process name: ' PROCESSCRASH; sudo find /var | grep $PROCESSCRASH; ls /var/crash; read -p 'Copy the route of your log crash file: ' ROUTECRASH; sudo mkdir /var/dump$PROCESSNAME; apport-unpack $ROUTECRASH /var/dump$PROCESSNAME; sudo apt-get purge apport-retrace python-problem-report python-apport"
...
alias emacssheet="firefox -new-tab http://www.stephenwalker.com/notes/aquamacsemacs-key-binding-list/ && firefox -new-tab https://www.emacswiki.org/ && firefox -new-tab http://www.ling.ohio-state.edu/~kyoon/tts/unix-help/LaTeX/emacs-cheatsheet-2-of-2.jpg && firefox -new-tab http://www.muylinux.com/wp-content/uploads/2010/11/Emacs-Cheatsheet-wallpaper.jpg && firefox -new-tab https://github.com/emacs-tw/awesome-emacs && firefox -new-tab http://es.tldp.org/Tutoriales/doc-tutorial-emacs/intro_emacs.pdf"
