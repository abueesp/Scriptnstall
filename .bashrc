...
alias emacssheet="echo 'SPC h l Layers'; echo 'SPC tilde Terminal'; echo 'SPC f e Configuration File'; echo 'SPC T s Themes'; firefox -new-tab https://spacemacs.org/doc/VIMUSERS.html && firefox -new-tab http://www.stephenwalker.com/notes/aquamacsemacs-key-binding-list/ && firefox -new-tab https://www.emacswiki.org/ && firefox -new-tab http://www.ling.ohio-state.edu/~kyoon/tts/unix-help/LaTeX/emacs-cheatsheet-2-of-2.jpg && firefox -new-tab http://www.muylinux.com/wp-content/uploads/2010/11/Emacs-Cheatsheet-wallpaper.jpg && firefox -new-tab https://github.com/emacs-tw/awesome-emacs && firefox -new-tab http://es.tldp.org/Tutoriales/doc-tutorial-emacs/intro_emacs.pdf"
