...
alias ytbmp3='youtube-dl --audio-format mp3 --audio-quality 0 --extract-audio  --prefer-ffmpeg --ignore-errors'
alias y2mp3='youtube-dl --audio-format mp3 --audio-quality 0 --extract-audio  --prefer-ffmpeg --ignore-errors'
